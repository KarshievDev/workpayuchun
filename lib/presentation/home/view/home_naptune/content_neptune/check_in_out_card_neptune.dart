...
class CheckInOutCardNeptune extends StatelessWidget {
  final Settings? settings;
  final LoginData? user;
  final DashboardModel? dashboardModel;

  const CheckInOutCardNeptune({super.key, required this.settings, required this.user, required this.dashboardModel});
          ...
          child: InkWell(
            onTap: () {
              context.read<HomeBloc>().add(
                OnLocationRefresh(user: context.read<AuthenticationBloc>().state.data?.user),
              );
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          offlineState.isCheckedIn == false ? "start_time".tr() : "done_for_today".tr(),
                          style: TextStyle(
                            fontSize: 16.r,
