...
////Task Group
//total task custom paint
class TotalTaskCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    paint0Fill.shader = ui.Gradient.linear(
        ...
        [const Color(0xff830010).withValues(alpha: 1), const Color(0xffFF0037).withValues(alpha: 1)],
        [0, 1]);
...
class TotalCompleteTaskCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..style=PaintingStyle.fill;
    paint0Fill.shader = ui.Gradient.linear(Offset(size.width*0.05772957,size.height*0.4476261), Offset(size.width*0.9354245,size.height*0.4476261), [const Color(0xff006318).withValues(alpha: 1),const Color(0xff00FF41).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_0,paint0Fill);
    ...
    Paint paint1Fill = Paint()..style=PaintingStyle.fill;
    paint1Fill.shader = ui.Gradient.linear(Offset(size.width*0.05772957,size.height*0.4476261), Offset(size.width*0.9354245,size.height*0.4476261), [const Color(0xff006318).withValues(alpha: 1),const Color(0xff00FF41).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_1,paint1Fill);

    Paint paint2Fill = Paint()..style=PaintingStyle.fill;
    paint2Fill.shader = ui.Gradient.radial(const Offset(0,0),size.width*0.007194245, [Colors.white.withValues(alpha: 1),const Color(0xffD9D9D9).withValues(alpha: 0)], [0,1]);
...
// task custom paint
class TotalTaskInProgressCustomPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..style=PaintingStyle.fill;
    paint0Fill.shader = ui.Gradient.linear(Offset(size.width*0.06282317,size.height*0.4444000), Offset(size.width*0.9405180,size.height*0.4444000), [const Color(0xff966700).withValues(alpha: 1),const Color(0xffFFAF00).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_0,paint0Fill);
    ...
    Paint paint1Fill = Paint()..style=PaintingStyle.fill;
    paint1Fill.shader = ui.Gradient.linear(Offset(size.width*0.06282317,size.height*0.4444000), Offset(size.width*0.9405180,size.height*0.4444000), [const Color(0xff966700).withValues(alpha: 1),const Color(0xffFFAF00).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_1,paint1Fill);
...
class TotalTaskInReviewCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..style=PaintingStyle.fill;
    paint0Fill.shader = ui.Gradient.linear(Offset(size.width*0.05797101,size.height*0.4427859), Offset(size.width*0.9420290,size.height*0.4427859), [const Color(0xff00606F).withValues(alpha: 1),const Color(0xff00DEFF).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_0,paint0Fill);
    ...
    Paint paint1Fill = Paint()..style=PaintingStyle.fill;
    paint1Fill.shader = ui.Gradient.linear(Offset(size.width*0.05797101,size.height*0.4427859), Offset(size.width*0.9420290,size.height*0.4427859), [const Color(0xff00606F).withValues(alpha: 1),const Color(0xff00DEFF).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_1,paint1Fill);

    Paint paint2Fill = Paint()..style=PaintingStyle.fill;
    paint2Fill.shader = ui.Gradient.radial(const Offset(0,0),size.width*0.007246377, [Colors.white.withValues(alpha: 1),const Color(0xffD9D9D9).withValues(alpha: 0)], [0,1]);
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint paint0Fill = Paint()..style=PaintingStyle.fill;
    paint0Fill.shader = ui.Gradient.linear(Offset(0,size.height*0.3480175), Offset(size.width,size.height*0.3480175), [const Color(0xff830010).withValues(alpha: 1),const Color(0xffFF0037).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_0,paint0Fill);
    ...
    Paint paint1Fill = Paint()..style=PaintingStyle.fill;
    paint1Fill.shader = ui.Gradient.linear(Offset(size.width*0.07484903,size.height*0.4616944), Offset(size.width*0.8424903,size.height*0.4616944), [const Color(0xff830010).withValues(alpha: 1),const Color(0xffFF0037).withValues(alpha: 1)], [0,1]);
    canvas.drawPath(path_1,paint1Fill);
    ...
    Paint paint2Fill = Paint()..style=PaintingStyle.fill;
    paint2Fill.shader = ui.Gradient.linear(Offset(size.width*0.09996839,size.height*0.4274452), Offset(size.width*0.8634323,size.height*0.4274452), [const Color(0xff830010).withValues(alpha: 1),const Color(0xffFF0037).withValues(alpha: 1)], [0,1]);
    ...
    paint3Fill.color = const Color(0xffEE2358).withValues(alpha: 1.0);
    ...
    paint4Fill.color = const Color(0xffEE2358).withValues(alpha: 1.0);
    ...
    paint5Fill.color = const Color(0xffEE2358).withValues(alpha: 1.0);
    ...
    paint6Fill.color = const Color(0xffEE2358).withValues(alpha: 1.0);
    ...
    paint7Fill.color = const Color(0xffEE2358).withValues(alpha: 1.0);
